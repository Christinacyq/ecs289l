...
import sys
sys.path.append('/content/ecs289l/baseline')
...
def parse_agrs():
    ...
    parser.add_argument('--load', type=str, default='results/XRGen/model_best.pth', help='whether to load a pre-trained model.')
